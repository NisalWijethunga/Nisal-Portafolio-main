...
const experiences = [
  {
    ...
    points: [
      "Developed responsive frontend components using ReactJS.",
      "Built backend APIs using NestJS and Node.js",
      "Firebase for backend services and real-time database management.",
      "MySQL for database design and optimization and Java for application development.",
      "Machine Learning for AI model development and dataset creation.",
      "Debugged and tested applications to improve stabilityand performance.",
      "Collaborated with senior developers throughout the software development lifecycle.",
      "Contributed to feature implementation and maintenance of client projects.",
    ],
  },
  {
    title: "Associate Software Engineer",
    company_name: "OceviaLab",
    icon: backend,
    iconBg: "#383E56",
    date: "January 2025 - June 2026",
    points: [
      "Develop responsive web applications using ReactJS, Next.js, and modern JavaScript.",
      "Build and maintain scalable backend APIs using Node.js and NestJS",
      "Design and optimize MySQL and MongoDB database schemas to improve application performance.",
      "Providing IT support and troubleshooting across our branches in Kalutara and Panadura.",
      "Implement RESTful APIs and integrate third-party services to support business requirements",
      "Manage source code using Git and contribute through feature branches and pull requests.",
      "Troubleshoot production issues and implement efficient solutions.",
      "Collaborate with UI/UX designers and cross-functional teams to deliver high-quality software solutions.",
    ],
  },
];
